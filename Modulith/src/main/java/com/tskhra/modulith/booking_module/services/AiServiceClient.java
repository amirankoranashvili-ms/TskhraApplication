...
public class AiServiceClient {
    ...
    public ProviderCreateResponse createProvider(ProviderCreateRequest request) {
        log.info("Creating AI provider for businessId: {}", request.businessId());
        ...
        try {
            ...
            log.info("AI provider created for businessId: {}", request.businessId());
            return response;
    ...
    public void generateOnboarding(OnboardingGenerateRequest request) {
        log.info("Generating onboarding for businessId: {}", request.businessId());
        ...
        try {
            ...
            log.info("Onboarding generated for businessId: {}", request.businessId());
        } catch (Exception e) {
